import { injectable, inject, ContainerModule, optional, AsyncContainerModule, Container } from "inversify";
...
const CmsEventBusServiceProvider = Symbol("CmsEventBusServiceProvider");
...
const CmsModule = new AsyncContainerModule((bind => __awaiter(void 0, void 0, void 0, (function*() {
    const {default: Emittery} = yield import("emittery");
    const {CmsImpl} = yield import("./cms-4431bd87.js");
    const {Cms14Impl} = yield import("./cms14-3409f051.js");
    const {PostMessage} = yield Promise.resolve().then((function() {
        return postMessage;
    }));
...
LinkRewriterImpl = __decorate([ injectable(), __param(0, inject(LinkFactory)), __param(1, inject(DomParserServiceProvider)), __param(2, inject(XmlSerializerServiceProvider)), __metadata("design:paramtypes", [ LinkFactory, Function, Function ]) ], LinkRewriterImpl);

const PageModelToken = Symbol.for("PageModelToken");

let PageImpl$1 = class PageImpl {
    constructor(model, buttonFactory, componentFactory, contentFactory, linkFactory, linkRewriter, metaFactory, cmsEventBusProvider, eventBus, logger) {
        this.model = model;
        ...
        this.metaFactory = metaFactory;
        this.cmsEventBusProvider = cmsEventBusProvider;
        this.logger = logger;
    ...
    sync() {
        return __awaiter(this, void 0, void 0, (function*() {
            const cmsEventBus = yield this.cmsEventBusProvider();
            cmsEventBus === null || cmsEventBus === void 0 ? void 0 : cmsEventBus.emit("page.ready", {});
        }));
    }
    toJSON() {
        return this.model;
    ...
    sanitize(content) {
        return __awaiter(this, void 0, void 0, (function*() {
            const {default: sanitizeHtml} = yield import("sanitize-html");
    ...
    prepareHTML(documentRef, dataFieldName) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, (function*() {
            const document = documentRef && this.getContent(documentRef);
            if (!document) {
                (_a = this.logger) === null || _a === void 0 ? void 0 : _a.warn(`Document reference "${documentRef}" not found in page model`);
                return null;
            }
            const data = document.getData();
            const htmlContent = dataFieldName && (data === null || data === void 0 ? void 0 : data[dataFieldName]);
            if (!htmlContent) {
                (_b = this.logger) === null || _b === void 0 ? void 0 : _b.warn(`Data field name "${dataFieldName}" not found in document data model`);
                return null;
            }
            return this.rewriteLinks(yield this.sanitize(htmlContent.value));
        }));
    }
};

PageImpl$1 = __decorate([ injectable(), __param(0, inject(PageModelToken)), __param(1, inject(ButtonFactory)), __param(2, inject(ComponentFactory$1)), __param(3, inject(ContentFactory$1)), __param(4, inject(LinkFactory)), __param(5, inject(LinkRewriterService)), __param(6, inject(MetaCollectionFactory)), __param(7, inject(CmsEventBusServiceProvider)), __param(8, inject(PageEventBusService)), __param(8, optional()), __param(9, inject(Logger)), __param(9, optional()), __metadata("design:paramtypes", [ Object, ButtonFactory, ComponentFactory$1, ContentFactory$1, LinkFactory, Object, Function, Function, Object, Logger ]) ], PageImpl$1);
...
PageImpl = PageImpl_1 = __decorate([ injectable(), __param(0, inject(PageModelToken)), __param(1, inject(ButtonFactory)), __param(2, inject(ComponentFactory)), __param(3, inject(ContentFactory)), __param(4, inject(LinkFactory)), __param(5, inject(LinkRewriterService)), __param(6, inject(MetaCollectionFactory)), __param(7, inject(CmsEventBusServiceProvider)), __param(8, inject(PageEventBusService)), __param(8, optional()), __param(9, inject(Logger)), __param(9, optional()), __metadata("design:paramtypes", [ Object, ButtonFactory, ComponentFactory, Function, LinkFactory, Object, Function, Function, Object, Logger ]) ], PageImpl);
...
function PageModule$1() {
    return new ContainerModule((bind => {
        ...
        bind(CmsEventBusServiceProvider).toProvider((context => () => new Promise((resolve => {
            try {
                if (context.container.isBound(CmsEventBusService)) {
                    const cmsEventBus = context.container.get(CmsEventBusService);
                    resolve(cmsEventBus);
                }
            } catch (e) {
                resolve(undefined);
        ...
        bind(DomParserServiceProvider).toProvider((() => () => __awaiter(this, void 0, void 0, (function*() {
            const {DOMParser} = yield import("@xmldom/xmldom");
            return new DOMParser;
        }))));
        bind(XmlSerializerServiceProvider).toProvider((() => () => __awaiter(this, void 0, void 0, (function*() {
            const {XMLSerializer} = yield import("@xmldom/xmldom");
...
function PageModule() {
    return new ContainerModule((bind => {
        ...
        bind(CmsEventBusServiceProvider).toProvider((context => () => new Promise((resolve => {
            let cmsEventBus;
            if (context.container.isBound(CmsEventBusService)) {
                cmsEventBus = context.container.get(CmsEventBusService);
            }
            resolve(cmsEventBus);
        }))));
        bind(LinkRewriterService).to(LinkRewriterImpl).inSingletonScope();
 ...
 */ let Spa = class Spa {
     ...
     */
    constructor(api, pageFactory, eventBus, logger) {
        this.api = api;
     ...
     */    initialize(modelOrPath) {
        ...
        return __awaiter(this, void 0, void 0, (function*() {
            if (typeof modelOrPath === "string") {
                ...
                const pageModel = yield this.api.getPage(modelOrPath);
     ...
     */    destroy() {
        var _a, _b;
        return __awaiter(this, void 0, void 0, (function*() {
            (_a = this.eventBus) === null || _a === void 0 ? void 0 : _a.clearListeners();
            delete this.page;
            (_b = this.logger) === null || _b === void 0 ? void 0 : _b.debug("Destroyed page.");
        }));
    }
};

Spa = __decorate([ injectable(), __param(0, inject(ApiService)), __param(1, inject(PageFactory)), __param(2, inject(PageEventBusService)), __param(2, optional()), __param(3, inject(Logger)), __param(3, optional()), __metadata("design:paramtypes", [ Object, Function, Object, Logger ]) ], Spa);
...
container.load(LoggerModule(), UrlModule$1());
...
function initializeWithProxy(scope, configuration, model) {
    ...
    return __awaiter(this, void 0, void 0, (function*() {
        ...
        const page = yield scope.get(SpaService).initialize((_j = (_g = model !== null && model !== void 0 ? model : configuration.path) !== null && _g !== void 0 ? _g : (_h = configuration.request) === null || _h === void 0 ? void 0 : _h.path) !== null && _j !== void 0 ? _j : "/");
        if (!((_k = scope.parent) === null || _k === void 0 ? void 0 : _k.isBound(CmsService))) {
            yield (_l = scope.parent) === null || _l === void 0 ? void 0 : _l.loadAsync(CmsModule);
        }
...
function initializeWithJwt09(scope, configuration, model) {
    ...
    return __awaiter(this, void 0, void 0, (function*() {
        ...
        const page = yield scope.get(SpaService).initialize(model !== null && model !== void 0 ? model : path);
        if (page.isPreview() && config.cmsBaseUrl) {
            logger.info("Running in preview mode.");
            if (!((_m = scope.parent) === null || _m === void 0 ? void 0 : _m.isBound(CmsService))) {
                yield (_o = scope.parent) === null || _o === void 0 ? void 0 : _o.loadAsync(CmsModule);
            }
            scope.get(PostMessageService).initialize(config);
            scope.get(CmsService).initialize(config, scope);
            yield page.sync();
        } else {
...
function initializeWithJwt10(scope, configuration, model) {
    ...
    return __awaiter(this, void 0, void 0, (function*() {
        ...
        if (page.isPreview() && config.endpoint) {
            logger.info("Running in preview mode.");
            if (!((_p = scope.parent) === null || _p === void 0 ? void 0 : _p.isBound(CmsService))) {
                yield (_q = scope.parent) === null || _q === void 0 ? void 0 : _q.loadAsync(CmsModule);
            }
            scope.get(PostMessageService).initialize(config);
            scope.get(CmsService).initialize(config, scope);
        } else {
 ...
 */ function initialize(configuration, model) {
    ...
    return __awaiter(this, void 0, void 0, (function*() {
        ...
        const page = isConfigurationWithProxy(configuration) ? yield initializeWithProxy(scope, configuration, model) : isConfigurationWithJwt09(configuration) ? yield initializeWithJwt09(scope, configuration, model) : yield initializeWithJwt10(scope, configuration, model);
...
export { TYPE_LINK_EXTERNAL as A, TYPE_LINK_INTERNAL as B, CmsEventBusService as C, TYPE_LINK_RESOURCE as D, TYPE_MANAGE_CONTENT_BUTTON as E, TYPE_MANAGE_MENU_BUTTON as F, extractSearchParams as G, Logger as L, META_POSITION_BEGIN as M, RpcClientService as R, SpaService as S, TYPE_CONTAINER_BOX as T, __decorate as _, __param as a, RpcServerService as b, __metadata as c, __awaiter as d, destroy as e, isComponent as f, getContainerItemContent as g, isContainerItem as h, initialize as i, isContainer as j, isContent as k, isDocument as l, isImageSet as m, isLink as n, isMenu as o, isMetaComment as p, isMeta as q, isPage as r, isPagination as s, isReference as t, META_POSITION_END as u, TYPE_CONTAINER_INLINE as v, TYPE_CONTAINER_NO_MARKUP as w, TYPE_CONTAINER_ORDERED_LIST as x, TYPE_CONTAINER_UNORDERED_LIST as y, TYPE_CONTAINER_ITEM_UNDEFINED as z };
//# sourceMappingURL=index-3575be7f.js.map
